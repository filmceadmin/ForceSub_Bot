    ...
    if chat_member.restricted_by:
      if chat_member.restricted_by.id == (client.get_me()).id:
          try:
            ...
            client.answer_callback_query(cb.id, text="❗ Join the mentioned 'channel' and press the 'Done ✅' button again.", show_alert=True)
      else:
      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              " {} , you are not subscribed to my channel yet. Please join using below button and press the Done ✅ button to unmute yourself and continue messaging.".format(message.from_user.mention, channel, channel),
            ...
            [
                ...
                [
                    InlineKeyboardButton("Done ✅", callback_data="onUnMuteRequest")
                ]
            ]
        )
          )
